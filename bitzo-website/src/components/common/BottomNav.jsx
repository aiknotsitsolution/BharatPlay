...
//                   }`}
//                   onLoad={() =>
//                     console.log("[BottomNav] avatar loaded", avatarUrl)
//                   }
//                   onError={(event) => {
//                     console.error("[BottomNav] avatar failed", {
//                       uri: avatarUrl,
//                       error: event.currentTarget?.src,
//                     });
...
//                 </div>
//                 {console.log("[BottomNav] avatar fallback rendered", item.label, isActive,avatarUrl)}
//               )
//             ) : (
//               <item.icon
//                 size={26}
...
//                 className="mb-0.5"
//               />
//               {console.log("[BottomNav] icon rendered", item.label, isActive)}
//             )}
