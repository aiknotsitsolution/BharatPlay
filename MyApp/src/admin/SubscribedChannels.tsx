  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        {/* Shorts Section - only on All or Shorts tab */}
        {(activeTab === "All" || activeTab === "Shorts") &&
          shortVideos.length > 0 && (
            <View style={styles.shortsSection}>
              {activeTab === "All" && (
              ...
              {activeTab === "Shorts" ? (
                // Full vertical list of shorts when on Shorts tab
                ...
                // Horizontal row when on All tab
                <FlatList
                  data={shortVideos.slice(0, 8)}
                  keyExtractor={(item) => `${item._id || item.id}-short`}
                  horizontal
        ...
        {/* Long Videos list - only on All / Videos / Today */}
        {(activeTab === "All" ||
          activeTab === "Videos" ||
          activeTab === "Today") && (
          <View style={styles.videosSection}>
...
const styles = StyleSheet.create({
  ...
  // Full shorts (vertical) for Shorts tab
  shortCardFull: {
    width: "100%",
    height: 280,
    borderRadius: 12,
