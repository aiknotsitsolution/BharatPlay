...
const ROLE_META = {
  ...
  finance: {
    ...
    bg: "bg-bp-yellow/15",
    borderColor: "border-bp-yellow/30",
    icon: DollarSign,
  ...
  "read-only": {
    label: "Read-Only",
    displayName: "Viewer",
    color: "text-bp-text-muted",
    bg: "bg-bp-text-muted/15",
    borderColor: "border-bp-text-muted/30",
    icon: Eye,
