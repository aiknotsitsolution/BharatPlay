    ...
    <div className="relative min-h-screen bg-bp-navy overflow-hidden flex items-center justify-center px-4 py-6">
      <div className="relative w-full max-w-[440px] animate-fade-in">
        <div className="glass-card p-6">
          ...
          <div className="mt-5 pt-4 border-t border-bp-border space-y-3">
            <p className="text-center text-sm text-bp-text-secondary">
              New admin?{" "}
              <Link to="/register" className="font-semibold underline underline-offset-2 hover:opacity-80 transition" style={{ color: "#FFFFFF" }}>
                Register
              </Link>
            </p>
            <p className="text-center text-sm text-bp-text-secondary">
              Employee login?{" "}
              <Link to="/employee-login" className="font-semibold underline underline-offset-2 hover:opacity-80 transition" style={{ color: "#FFFFFF" }}>
                Staff Portal
              </Link>
            </p>
          </div>
