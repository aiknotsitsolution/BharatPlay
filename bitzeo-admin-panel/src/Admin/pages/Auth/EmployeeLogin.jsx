        ...
        <div className="glass-card p-6">
          ...
          <div className="flex flex-col items-center text-center gap-3 mb-5">
            ...
            <div>
              ...
              <p className="text-bp-text-secondary mt-1.5 text-sm">Employee &amp; Staff Login</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {loginError && (
              <div className="rounded-lg border border-red-200 bg-red-50 px-3.5 py-2.5 text-sm text-red-700">{loginError}</div>
            )}
          ...
          <div className="mt-5 pt-4 border-t border-bp-border">
            <p className="text-center text-sm text-bp-text-secondary">
              Admin login? <Link to="/admin-login" style={{ color: "#FFFFFF" }} className="font-medium hover:opacity-80 transition">Admin Panel</Link>
            </p>
          </div>
        </div>
      </div>
